...
// //             api.post("HelpCreation", { Type: 4, PageTitleId: 427 })
// //          ]);
...
//           return {
//             ...doc,
//             Page_Name: doc.Page_Name?.trim(),
//             PageTitleId: computedPageTitleId,
//             id: doc.Id,
//             serialNo: doc.Id
//           };
//         });
...
//                   onChange={(event, newValue) => {
//                     if (newValue) {
//                       const rootId = findRootParentId(newValue.value, MenuTypeOptions);
//                       const matchedHelp: any = HelpCreations.find((help: any) => help.PageTitleId === rootId);

//                       formik.setValues({
//                         ...formik.values,
//                         PageTitleId: rootId,
//                         pagename: newValue.label,
//                         frontDesign: matchedHelp ? matchedHelp.frontDesign : "",
//                       });
//                     }
//                   }}
//                   getOptionLabel={(option) => {
