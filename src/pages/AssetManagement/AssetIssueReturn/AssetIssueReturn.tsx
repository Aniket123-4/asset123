...
export default function AssetIssueReturn() {
  ...
  const routeChangeEdit = (row: any) => {
    ...
    let path = `/AssetManagement/EditAssetIssueReturn`;
    navigate(path, {
      state: row,
    });
  };
  ...
  const routeChangeAdd = () => {
    let path = `/AssetManagement/CreateAssetIssueReturn`;
    navigate(path);
  };
