...
const EditAssetIssueReturn = (props: Props) => {
  ...
  const formik = useFormik({
    initialValues: {
      "resCode": location.state.rescode || location.state.resCode,
      "resname": location.state.resname,
      "ResTypeCode": location.state.ResTypeCode,
      "ResType": location.state.ResType,
      "status": location.state.status.toLowerCase(),
      "membertype": location.state.membertype,
      "resid": location.state.resid,
      "empid": location.state.empid,
      "empname": location.state.empname,
      "cat": location.state.cat,
      "dept": location.state.dept,
      "issuedate": location.state.issuedate || defaultValues,
      "returndate": location.state.returndate || defaultValues,
              ...
              <Grid item xs={12} sm={4} lg={4}>
                ...
                {formik.touched.resCode && formik.errors.resCode ? (
                  <div style={{ color: "red", margin: "5px" }}>
                    {formik.errors.resCode.toString()}
                  </div>
                ) : null}
              </Grid>
...
export default EditAssetIssueReturn;