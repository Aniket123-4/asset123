                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={3}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={checkedItems.resourceDetail}
                  ...
                  <Grid item xs={12} sm={3}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={checkedItems.generalInfo}
                          onChange={handleChange}
                          name="generalInfo"
                        />
                      }
                  ...
                  <Grid item xs={12} sm={3}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={checkedItems.purchaseDetail}
                          onChange={handleChange}
                          name="purchaseDetail"
                        />
                      }
                  ...
                  <Grid item xs={12} sm={3}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={checkedItems.utilizationLog}
                          onChange={handleChange}
                          name="utilizationLog"
                        />
                      }
                  ...
                  <Grid item xs={12} sm={3}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={checkedItems.breakDown}
                          onChange={handleChange}
                          name="breakDown"
                        />
                      }
                  ...
                  <Grid item xs={12} sm={3}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={checkedItems.maintenance}
                          onChange={handleChange}
                          name="maintenance"
                        />
                      }
                  ...
                  <Grid item xs={12} sm={3}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={checkedItems.licensing}
                          onChange={handleChange}
                          name="licensing"
                        />
                      }
