...
export default function UtilizationLog() {
  ...
  const routeChangeEdit = (row: any) => {
    ...
    let path = `/AssetDescription/EditUtilizationLog`;
    navigate(path, {
      state: { ...row, UL_ID: row.UL_ID }
    });
  };

  const routeChangeAdd = () => {
    let path = `/AssetDescription/AddUtilizationLog`;
    navigate(path);
  };
  ...
  const accept = () => {
    api
      .post(`Master/DeleteUtilizationLog?id=${delete_id}`)
      .then((response) => {
