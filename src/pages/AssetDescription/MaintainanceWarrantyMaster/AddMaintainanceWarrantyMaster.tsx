...
const AddMaintainanceWarrantyMaster = (props: Props) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      "id_MW": "-1",
      "MaintenanceDate": defaultValues,
      "Warrenty": "",
      "WarrentyFDate": defaultValues,
      "WarrentyTDate": defaultValues,
      "WarrentyValue": "",
      "WarrentyRemark": "",
      "VenderName": "",
      "inst": "",
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={4} lg={4}>
                ...
                />
 {formik.touched.VenderName && formik.errors.VenderName ? (
                                    <div style={{ color: "red", margin: "5px" }}>
                                        {formik.errors.VenderName}
                                    </div>
                                ) : null}
              ...
              <Grid container spacing={1} item>
                ...
                >
                  <TextField
                    ...
                    onChange={(e) => otherDocChangeHandler(e, "FileContent")}
                  />
                </Grid>
